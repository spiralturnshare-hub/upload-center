...
function SectionCard({ icon, title, stepLabel, onEdit, children }: SectionCardProps) {
  return (
    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
      ...
      >
        {icon}
        <h3 className="text-sm font-semibold flex-1" style={{ color: 'var(--primary)' }}>{title}</h3>
        <button
          onClick={onEdit}
  ...
  return (
    ...
    >
      <div className="space-y-4">
        ...
        {/* ─── STEP 1: 動画アップロード ─── */}
        <SectionCard
          icon={<Video className="w-4 h-4" style={{ color: 'var(--primary)' }} />}
        ...
        {/* ─── STEP 2: 写真アップロード ─── */}
        <SectionCard
          icon={<Camera className="w-4 h-4" style={{ color: 'var(--primary)' }} />}
        ...
        {/* ─── STEP 3: 靴情報 ─── */}
        <SectionCard
          icon={<Footprints className="w-4 h-4" style={{ color: 'var(--primary)' }} />}
          title="STEP 3：靴情報"
        ...
        {/* ─── STEP 4: 痛みに関する情報 ─── */}
        <SectionCard
          icon={<Heart className="w-4 h-4" style={{ color: 'var(--primary)' }} />}
        ...
        {/* ─── STEP 6: タコ・魚の目 ─── */}
        <SectionCard
          icon={<Leaf className="w-4 h-4" style={{ color: 'var(--primary)' }} />}
        ...
        {/* ─── STEP 7: お客様情報・配送先 ─── */}
        <SectionCard
          icon={<User className="w-4 h-4" style={{ color: 'var(--primary)' }} />}
