        ...
        {!isConfirmed ? (
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mt-4">
            ...
            <div className="space-y-4">
              ...
              <Button onClick={handleVerify} disabled={loading} className="w-full" style={{ backgroundColor: 'var(--primary)' }}>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mt-4 space-y-4">
            ...
            <Button onClick={handleStartUpload} className="w-full" style={{ backgroundColor: 'var(--primary)' }}>
