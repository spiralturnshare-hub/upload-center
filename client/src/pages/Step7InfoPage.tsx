  ...
  return (
    <div className="space-y-1.5">
      <label className="text-sm font-semibold text-gray-700 flex items-center gap-1">
        {label}
        {required && (
          <span className="text-xs font-medium px-1.5 py-0.5 rounded text-white" style={{ backgroundColor: 'var(--primary)' }}>必須</span>
        )}
      </label>
      {children}
    </div>
      ...
      <div className="space-y-5">
        ...
        <div>
          <div className="flex items-center gap-2 mb-1">
            <div className="w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold text-white" style={{ backgroundColor: 'var(--primary)' }}>7</div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 space-y-4">
          ...
          <Field label="インソールをご利用いただく方のお名前" required>
            <input
              ...
              onFocus={e => (e.target.style.borderColor = fieldErrors.userName ? ERROR_BORDER : 'var(--primary)')}
          ...
          <Field label="フリガナ" required>
            <input
              ...
              onFocus={e => (e.target.style.borderColor = fieldErrors.userKana ? ERROR_BORDER : 'var(--primary)')}
          ...
          {isLoggedIn && isProfileRegistered && (
            <div className="space-y-2">
              <button
                ...
                style={{
                  borderColor: shipMode === 'account' ? 'var(--primary)' : '#E5E7EB',
                  backgroundColor: shipMode === 'account' ? 'var(--primary-tint)' : 'white',
                }}
              >
                <div className="flex items-center gap-2">
                  <div className="w-5 h-5 rounded-full border-2 flex items-center justify-center shrink-0"
                    style={{ borderColor: shipMode === 'account' ? 'var(--primary)' : '#9CA3AF' }}>
                    {shipMode === 'account' && (
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="text-sm font-semibold" style={{ color: 'var(--primary)' }}>このアカウントの住所に郵送</span>
                    </div>
                    {accountProfile && (
              ...
              <button
                ...
                className="w-full rounded-xl border-2 p-3 text-left transition-all duration-150 active:scale-[0.99]"
                style={{
                  borderColor: shipMode === 'other' ? 'var(--primary)' : '#E5E7EB',
                  backgroundColor: shipMode === 'other' ? 'var(--primary-tint)' : 'white',
                }}
              >
                <div className="flex items-center gap-2">
                  <div className="w-5 h-5 rounded-full border-2 flex items-center justify-center shrink-0"
                    style={{ borderColor: shipMode === 'other' ? 'var(--primary)' : '#9CA3AF' }}>
                    {shipMode === 'other' && (
                      <div className="w-2.5 h-2.5 rounded-full" style={{ backgroundColor: 'var(--primary)' }} />
                    )}
                  </div>
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-sm font-semibold" style={{ color: 'var(--primary)' }}>別の住所に郵送</span>
                  </div>
                </div>
              </button>
            </div>
            ...
            <div className="space-y-4 pt-2">
              <Field label="お名前" required>
                <input
                  ...
                  onFocus={e => (e.target.style.borderColor = fieldErrors.shipName ? ERROR_BORDER : 'var(--primary)')}
              ...
              <Field label="電話番号" required>
                <input
                  ...
                  onFocus={e => (e.target.style.borderColor = fieldErrors.phone ? ERROR_BORDER : 'var(--primary)')}
                ...
                <div className="grid grid-cols-2 gap-2">
                  {[
                    ...
                    <button
                      ...
                      style={{
                        borderColor: altForm.isOverseas === opt.value ? 'var(--primary)' : '#E5E7EB',
                        backgroundColor: altForm.isOverseas === opt.value ? 'var(--primary-tint)' : 'white',
                        color: altForm.isOverseas === opt.value ? 'var(--primary)' : '#374151',
                      }}
                    >
                      {opt.label}
                    </button>
                  ...
                  <Field label="郵便番号" required>
                    <div className="flex gap-2">
                      <input
                        ...
                        onFocus={e => (e.target.style.borderColor = fieldErrors.postalCode ? ERROR_BORDER : 'var(--primary)')}
