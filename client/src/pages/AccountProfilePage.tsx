...
const inputStyle = { '--focus-color': 'var(--primary)' } as React.CSSProperties;
  ...
  return (
    ...
    >
      <div className="space-y-5">
        {/* ヘッダー */}
        <div className="rounded-2xl p-4 text-sm text-gray-600" style={{ backgroundColor: 'var(--primary-tint)' }}>
          {isEditing
          ...
          <div className="grid grid-cols-2 gap-3">
            <Field label="姓" required>
              <input type="text" value={form.firstName}
                ...
                onFocus={e => (e.target.style.borderColor = fieldErrors.firstName ? ERROR_BORDER : 'var(--primary)')}
            ...
            <Field label="名" required>
              <input type="text" value={form.lastName}
                ...
                onFocus={e => (e.target.style.borderColor = fieldErrors.lastName ? ERROR_BORDER : 'var(--primary)')}
          ...
          <div className="grid grid-cols-2 gap-3">
            <Field label="姓（フリガナ）" required>
              <input type="text" value={form.firstNameKana}
                ...
                onFocus={e => (e.target.style.borderColor = fieldErrors.firstNameKana ? ERROR_BORDER : 'var(--primary)')}
            ...
            <Field label="名（フリガナ）" required>
              <input type="text" value={form.lastNameKana}
                ...
                onFocus={e => (e.target.style.borderColor = fieldErrors.lastNameKana ? ERROR_BORDER : 'var(--primary)')}
          ...
          <div className="grid grid-cols-2 gap-2">
            {[
              ...
              <button
                ...
                style={{
                  borderColor: form.isOverseas === opt.value ? 'var(--primary)' : '#E5E7EB',
                  backgroundColor: form.isOverseas === opt.value ? 'var(--primary-tint)' : 'white',
                  color: form.isOverseas === opt.value ? 'var(--primary)' : '#374151',
                }}
              >
                {opt.label}
              </button>
