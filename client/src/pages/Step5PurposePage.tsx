        ...
        {options.map(opt => (
          <button key={opt} onClick={() => onChange(opt)}
            ...
            style={{
              ...
              backgroundColor: value === opt ? 'var(--primary-tint)' : 'white',
              color: value === opt ? 'var(--primary)' : '#374151',
            }}
          >
            <div className="w-4 h-4 rounded-full border-2 flex items-center justify-center flex-shrink-0"
              style={{ borderColor: value === opt ? 'var(--primary)' : '#D1D5DB' }}>
              {value === opt && <div className="w-2 h-2 rounded-full" style={{ backgroundColor: 'var(--primary)' }} />}
            </div>
          ...
          return (
            <button key={opt} onClick={() => toggle(opt)}
              ...
              style={{
                ...
                backgroundColor: checked ? 'var(--primary-tint)' : 'white',
                color: checked ? 'var(--primary)' : '#374151',
              }}
            >
              <div className="w-4 h-4 rounded border-2 flex items-center justify-center flex-shrink-0"
                style={{ borderColor: checked ? 'var(--primary)' : '#D1D5DB', backgroundColor: checked ? 'var(--primary)' : 'transparent' }}>
                {checked && (
      ...
      <div className="space-y-5">
        ...
        <div>
          <div className="flex items-center gap-2 mb-1">
            <div className="w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold text-white" style={{ backgroundColor: 'var(--primary)' }}>5</div>
              ...
              >
                ...
                <div>
                  <div className="flex items-center gap-2 mb-2">
                    <div className="w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold text-white" style={{ backgroundColor: 'var(--primary)' }}>右</div>
                ...
                <div>
                  <div className="flex items-center gap-2 mb-2">
                    <div className="w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold text-white" style={{ backgroundColor: 'var(--primary)' }}>左</div>
